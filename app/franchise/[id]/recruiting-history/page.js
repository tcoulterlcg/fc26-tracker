  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <h1 className="text-3xl md:text-4xl font-bold uppercase tracking-wide mt-5 mb-1">Recruiting History</h1>
        ...
        <div className="bg-neutral-900/60 border border-neutral-800 rounded-xl p-6">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-neutral-200 mb-4">Recruiting Classes ({recruits.length})</h2>
          {recruits.length === 0 ? (
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-neutral-400 text-[11px] uppercase tracking-wide border-b border-neutral-800">
                    ...
                    <th className="text-left font-semibold py-2.5 px-3">Pos</th>
                    <th className="text-left font-semibold py-2.5 px-3">Stars</th>
                    <th className="text-left font-semibold py-2.5 px-3">Home State</th>
                ...
                <tbody>
                  {recruits.map(function(r) {
                    return (
                      <tr key={r.id} className="border-b border-neutral-800/60 last:border-0 hover:bg-neutral-800/40 transition-colors">
                        ...
                        <td className="py-2.5 px-3 text-neutral-300">{r.position || '-'}</td>
